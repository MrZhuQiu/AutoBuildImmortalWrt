...
##修改版
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-advancedplus luci-i18n-advancedplus-zh-cn -luci-app-argon-config -luci-i18n-argon-config-zh-cn -luci-i18n-diskman -luci-app-openclash -luci-i18n-homeproxy-zh-cn -openssh-sftp-server -luci-i18n-samba4-zh-cn -luci-i18n-dufs-zh-cn"
# 网络测速 by sirpdboy 
